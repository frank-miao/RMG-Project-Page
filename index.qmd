    ...
    <div class="container">
      ...
      <div class="columns is-multiline results-grid">
        ...
        <div class="column is-one-third">
          <div class="item">
            <video autoplay controls muted loop playsinline>
              <source src="static/videos/A person bows.mp4" type="video/mp4">
            </video>
          </div>
        </div>
        ...
        <div class="column is-one-third">
          <div class="item">
            <video autoplay controls muted loop playsinline>
              <source src="static/videos/A person is doing a salsa dance.mp4" type="video/mp4">
            </video>
          </div>
        </div>
        ...
        <div class="column is-one-third">
          <div class="item">
            <video autoplay controls muted loop playsinline>
              <source src="static/videos/A person performs a standing back kick.mp4" type="video/mp4">
            </video>
          </div>
        </div>
        ...
        <div class="column is-one-third">
          <div class="item">
            <video autoplay controls muted loop playsinline>
              <source src="static/videos/The person puts something on its side and then brings it back to normal.mp4" type="video/mp4">
            </video>
          </div>
        </div>
